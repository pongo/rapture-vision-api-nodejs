...
import metadownloader from "metadownloader";
...
export const fetchMetadownloader = InstagramFactory("instagram/metadownloader", {
  async fetchFn(id) {
    return await metadownloader(urlFromId(id));
  },
  parseFn(data) {
